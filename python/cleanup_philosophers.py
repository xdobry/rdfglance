...
# ------------------------
g = Graph()
g.parse("sample-rdf-data/philosophers.ttl", format="ttl")
...
add_missing_types(g, "dbo:influenced", "dbo:Philosopher")

g.serialize("sample-rdf-data/philosophers2.ttl", format="ttl")
print("Updated graph saved to sample-rdf-data/philosophers.ttl")